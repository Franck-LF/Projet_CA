...
# From my own python  (file: tools.py)
...
# Save the data vectorized (USELESS)
filename = f"VECTORS/X_texts_test.npz"
sp.sparse.save_npz(filename, tfidf_texts_matrix)

# Save the vectorizer
filename = f"MODELS/vectorizer_ia_texts_test.pkl"
...
with mlflow.start_run():
    ...
    # Save the model
    filename = f"MODELS/reglog_ia_texts_test.pkl"
    with open(filename, 'wb') as file:
    ...
    mlflow.log_metric("F1-Score", f1_score(y_train, y_pred))
